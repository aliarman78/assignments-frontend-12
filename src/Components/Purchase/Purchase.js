...
const Purchase = () => {
    ...
    const onSubmit = data => {
        console.log(data)
        const url = `https://assign1233.herokuapp.com/orders`;
        fetch(url, {
            method: 'POST',
            headers: {
    ...
    useEffect(() => {
        const url = `https://assign1233.herokuapp.com/inventory/${detailId}`;
        fetch(url)
            .then(res => res.json())
    ...
    return (
        <div>
            ...
            <div className='d-flex justify-content-center'>
                <div>
                    <h1 className='mt-3  text-3xl font-bold'>Purchase Information</h1>
