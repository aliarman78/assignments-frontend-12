    ...
    return (
        <div>            
            ...
            <div className='text-start mt-5 font-bold text-lg'>
                ...
                <h6>aliarman787878@gmail.com</h6>
                <p>Anowara, chittagong</p>
                <p>Phone: 01795661208</p>
            </div>
            ...
            <div className='text-start mb-5 mt-4'>
                ...
                <h3 className=' font-bold'> <a href="https://assignment11-802a5.web.app/">First Project</a></h3>
                <h3 className=' font-bold'> <a href="https://cosmic-pie-96f6c2.netlify.app/">Second Project</a></h3>
                <h3 className=' font-bold'> <a href="https://luxury-pithivier-e23706.netlify.app/">Third Project</a></h3>
            </div>
            </div>
        </div>
    );
